...
class Placeholder
{
     ...
     */
    public function __construct(private readonly string $value, private readonly string $identifier, private readonly array $modifiers, private readonly string $placeholder, private readonly ?string $language = null)
    {
    }

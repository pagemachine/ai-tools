...
class ImageMetaDataService
{
     ...
     * @throws \Exception
     */
    public function generateImageDescription(FileInterface $fileObject, string $textPrompt = '', string $targetLanguage = 'en', int $language = 0, string $promptLanguage = 'auto', ?string $translationProvider = null): string
    {
        $serverClass = $this->serverService->getActiveServerClassByFunctionality('image_recognition');
        ...
        return $serverClass->sendFileToApi($processedImage, $placeholdersResult, $targetLanguage, $promptLanguage, $translationProvider);
    }
